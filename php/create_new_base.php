<?php
	...
	if(isset($_POST['password']) && isset($_POST["folder_name"]) && isset($_POST["filename"]) && isset($_POST["img0"]))
	{
		...
		{
			die("create_new_base.php::error::folder [$folder_name] not found");
		...
		{
			die("create_new_base.php::error::Wrong password [$pswd] for folder [$folder_name]");
		}			
		...
		{
			die("create_new_base.php::error::file [$$fulljsonname] found");
		...
		{
			die("create_new_base.php::error::file [$$fullpngname] found");
...
**/			
			echo "create_new_base.php::success";

	}
	else 
	{ 
		echo "create_new_base.php::error::wrong parameters error";
